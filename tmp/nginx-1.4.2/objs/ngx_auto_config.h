#define NGX_CONFIGURE " --prefix=/home/gaowei/gitcode/rtmpserver/tmp/nginx --with-ipv6 --with-http_ssl_module --with-http_realip_module --with-http_addition_module --with-http_sub_module --with-http_gunzip_module --with-http_gzip_static_module --with-http_stub_status_module --with-pcre=/home/gaowei/gitcode/rtmpserver/tmp/pcre-8.33/ --with-pcre-jit --with-openssl=/home/gaowei/gitcode/rtmpserver/tmp/openssl-1.0.1e/ --with-cc-opt=-Wno-error --with-debug --with-ld-opt=-lstdc++ --without-http_userid_module --without-mail_pop3_module --without-mail_imap_module --without-mail_smtp_module --add-module=/home/gaowei/gitcode/rtmpserver/tmp//nginx-rtmp-module"
...
#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 3.4.5 20051201 (Red Hat 3.4.5-2)"
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/home/gaowei/gitcode/rtmpserver/tmp/nginx/"
#endif
